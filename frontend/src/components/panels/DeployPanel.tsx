...
import { X, Rocket, Bot, Server, Loader2, Check, FileCode } from 'lucide-react';
      ...
      <div style={{ flex: 1, overflow: 'auto' }}>
        ...
        {deployResult && (
          <div style={{ ...sectionStyle, background: '#0f291a' }}>
            ...
            {deployConfig.hcs10.enabled && (
              <div style={{ marginTop: '10px', padding: '8px', background: '#1e293b', borderRadius: '6px', fontSize: '12px', color: '#94a3b8' }}>
                Next: Run <code style={{ color: '#a855f7' }}>npm run register-agent</code> in the generated project to register on HCS-10.
              </div>
            )}
          </div>
        )}
